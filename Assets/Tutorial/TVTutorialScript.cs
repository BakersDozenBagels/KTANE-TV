...
public class TVTutorialScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        c.transform.position = TestScene ? new Vector3(0f, -1f, 0f) : transform.position * 10 + new Vector3(0f, 1000f, 0f);
        ...
        videoScreen.GetComponent<Renderer>().material.mainTexture = Rig.Camera.targetTexture;
    ...
    private void UpdateScreen()
    {
        switch(screenMode)
        {
            case 2:
                ...
                Player.Stop();
                Rig.GetComponentInChildren<RenderDepth>().enabled = true;
                break;
            case 3:
                ...
                blackScreen.transform.localPosition = new Vector3(0f, 0f, -0.1f);
                //Player.Play();
                Rig.GetComponentInChildren<RenderDepth>().enabled = false;
                break;
            default:
                Source1.AudioSource.mute = true;
                Source2.AudioSource.mute = true;
